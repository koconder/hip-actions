...
;// CONCATENATED MODULE: ./src/sonar.ts
...
class SonarCloudClient {
    ...
    register(repositoryName, mainBranchName) {
        return __awaiter(this, void 0, void 0, function* () {
            const project = `${this.org}_${repositoryName}`;
            try {
                const { components } = yield this.searchProjects(this.org, repositoryName);
                const found = components.find(({ key, name }) => key === project && name === repositoryName);
                if (!found) {
                    yield this.createProject(repositoryName, project, this.org);
                }
                const { branches } = yield this.getBranches(project);
                if (branches.find(({ name, isMain }) => name === mainBranchName && isMain === false)) {
                    yield this.deleteBranch(project, mainBranchName);
                }
                yield this.renameBranch(project, mainBranchName);
            }
            catch (error) {
    ...
    searchProjects(organization, q) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data } = yield this.axios.get('/api/projects/search', { params: { organization, q } });
            return data;
        });
    }
    createProject(name, project, organization) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = new URLSearchParams();
            params.append('name', name);
            params.append('project', project);
            params.append('organization', organization);
            yield this.axios.post('/api/projects/create', params);
        });
    }
    getBranches(project) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data } = yield this.axios.get('/api/project_branches/list', { params: { project } });
            return data;
        });
    }
    deleteBranch(project, branch) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = new URLSearchParams();
            params.append('project', project);
            params.append('branch', branch);
            yield this.axios.post('/api/project_branches/delete', params);
        });
    }
    renameBranch(project, name) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.axios.post('/api/project_branches/rename', null, { params: { project, name } });
        });
    }
    static handle(error) {
        var _a, _b, _c, _d;
        if (axios_default().isAxiosError(error)) {
            const message = (_d = (_c = (_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.errors) === null || _c === void 0 ? void 0 : _c.map((error) => error === null || error === void 0 ? void 0 : error.msg)) === null || _d === void 0 ? void 0 : _d.shift();
            throw new Error(message || (error === null || error === void 0 ? void 0 : error.message));
        }
        else {
            throw error;
        }
...
const repo = process.env.CI_REPOSITORY_NAME;
