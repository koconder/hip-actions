/******/ (() => {
  ...
  (() => {
    ...
    var axios_default = /*#__PURE__*/ __nccwpck_require__.n(axios); // CONCATENATED MODULE: ./src/sonar.ts
    var __awaiter =
    ...
    class SonarCloudClient {
      ...
      register(repositoryName, mainBranchName) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            const { components } = yield this.searchProjects(
              this.org,
              repositoryName
            );
            const found = components.find(
              ({ key, name }) => key === project && name === repositoryName
            );
            if (!found) {
            ...
            if (
              branches.find(
                ({ name, isMain }) =>
                  name === mainBranchName && isMain === false
              )
            ) {
      ...
      searchProjects(organization, q) {
        return __awaiter(this, void 0, void 0, function* () {
          const { data } = yield this.axios.get('/api/projects/search', {
            params: { organization, q },
          });
          return data;
        });
      }
      ...
      getBranches(project) {
        return __awaiter(this, void 0, void 0, function* () {
          const { data } = yield this.axios.get('/api/project_branches/list', {
            params: { project },
          });
          return data;
        });
      ...
      renameBranch(project, name) {
        return __awaiter(this, void 0, void 0, function* () {
          yield this.axios.post('/api/project_branches/rename', null, {
            params: { project, name },
          });
        });
      }
            ...
            (_d =
              (_c =
                (_b =
                  ...
                  ? void 0
                  : _b.errors) === null || _c === void 0
                ? void 0
                : _c.map((error) =>
                    error === null || error === void 0 ? void 0 : error.msg
                  )) === null || _d === void 0
              ? void 0
              : _d.shift();
          throw new Error(
